...
/*
 * Changes in mplayer2:
 * - If no memory is available, abort() is called (instead of returning NULL)
 * - export void talloc_report_null_full(void)
 * - fix talloc_strndup_append_buffer (fixed upstream)
 * - Probably some more hacks
 *
